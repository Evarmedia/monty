 ...
 * @counter_numb: the line number been read
...
void push(stack_t **stack, unsigned int counter_numb);
void free_stack(stack_t *head);
int check_digit_(char *str);
void free_head(void);
void pall(stack_t **stack, unsigned int counter_numb);
void pint(stack_t **stack, unsigned int counter_numb);
void pop(stack_t **stack, unsigned int counter_numb);
void swap(stack_t **stack, unsigned int counter_numb);
void nop(stack_t **stack, unsigned int counter_numb);
int count_stacks(stack_t *stack);
void add(stack_t **stack, unsigned int counter_numb);
 ...
 */
void _div(stack_t **stack, unsigned int counter_numb);
void mul(stack_t **stack, unsigned int counter_numb);
void mod(stack_t **stack, unsigned int counter_numb);
void handle_hash(void);
void pchar(stack_t **stack, unsigned int counter_numb);
void pstr(stack_t **stack, unsigned int counter_numb);
